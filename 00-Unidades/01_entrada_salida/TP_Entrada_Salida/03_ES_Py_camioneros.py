...
3.	Para el departamento de logística:
    ...
    si sabemos que cada camión puede ir a una velocidad máxima y constante de 90 km/hl.  
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        alert("Cantidad de camiones por toneladas", f"Para cargar {toneladas} toneladas se necesitaran {camiones} camiones.")
